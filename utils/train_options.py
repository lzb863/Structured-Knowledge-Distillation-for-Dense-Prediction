...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument('--classes_num', default=9, type=int,metavar='N', help='class num of the dataset')
        ...
        parser.add_argument("--data-dir", type=str, default='/home/remo/Desktop/structure_knowledge_distillation-master/dataset/demo', help="Path to the directory containing the PASCAL VOC dataset.")
        ...
        parser.add_argument("--input-size", type=str, default='256,256', help="Comma-separated string with height and width of images.")
        ...
        parser.add_argument("--is-student-load-imgnet", type=str2bool, default='False', help="is student load imgnet")
